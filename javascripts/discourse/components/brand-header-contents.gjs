      ...
      <nav class="links">
        <ul class="nav {{if this.shouldShow 'nav-pills'}}">
          {{#each settings.links as |link|}}
            <li>
              <a href={{link.url}} target={{link.target}} {{if link.title (concat 'title=\"' link.title '\"')}}>
                {{link.text}}
              </a>
            </li>
          {{/each}}
      ...
      <div class="panel">
        <ul class="icons">
          {{#each settings.icons as |iconLink|}}
            <li>
              <a href={{iconLink.url}} target={{iconLink.target}} {{if iconLink.title (concat 'title=\"' iconLink.title '\"')}}>
